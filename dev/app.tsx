...
const FeedbackPage = () => {
  ...
  return (
    <>
      ...
      <S title="Nested Overflow (clip-proof)">
        <p className="text-sm text-muted-foreground">
          The card below is <code className="font-mono text-xs">overflow-hidden</code>, short, and
          transformed - everything a non-portalled overlay gets clipped by. Each overlay renders
          into <code className="font-mono text-xs">document.body</code>, so it stays whole.
        </p>
